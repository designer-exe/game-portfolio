...
//             'color: #705df2;'
//         )
        console.log('%cWelcome to Animesh Gupta\'s 3D Portfolio!', 'color: #D6A77A; font-weight: bold; font-size: 14px;');
        console.log('%cProduct & Game Designer based in India • Available Worldwide', 'color: #B9825A');
        console.log('%cExplore the projects, services & design lab! Contact: officialanimesh28@gmail.com', 'color: #F4E8D8');
        console.log('%c— Animesh Gupta', 'color: #D6A77A');
    }
