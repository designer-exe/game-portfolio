...
export default class Materials
{
    ...
    setPures()
    {
        ...
        this.pures.items.yellow = new THREE.MeshBasicMaterial({ color: 0x6FAF72 })
        this.pures.items.yellow.name = 'pureYellow'
        this.pures.items.orange = new THREE.MeshBasicMaterial({ color: 0xB9825A })
        this.pures.items.orange.name = 'pureOrange'
    }
    ...
    setShades()
    {
        ...
        this.shades = {}
        this.shades.items = {}
        this.shades.indirectColor = '#824E38'
    ...
    setFloorShadow()
    {
        ...
        this.items.floorShadow.shadowColor = '#180B08'
