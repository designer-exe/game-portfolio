...
export default class Physics
{
    ...
    setCar()
    {
        ...
        this.car.options.wheelSuspensionRestLength = 0.14
        this.car.options.wheelFrictionSlip = 16
        this.car.options.wheelDampingRelaxation = 2.3
        this.car.options.wheelDampingCompression = 2.0
        ...
        this.time.on('tick', () =>
        {
            ...
            if(this.controls.actions.up || this.controls.actions.down || this.controls.actions.left || this.controls.actions.right)
            {
                this.car.chassis.body.wakeUp()
            }
            ...
            if(this.car.options.controlsAcceleratingQuad)
            {
